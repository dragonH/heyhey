...
public abstract class AppCompatDelegate {
  ...
  private static AppCompatDelegate create(Context paramContext, Window paramWindow, AppCompatCallback paramAppCompatCallback) {
    ...
    return (i >= 24) ? new AppCompatDelegateImplN(paramContext, paramWindow, paramAppCompatCallback) : ((i >= 23) ? new AppCompatDelegateImplV23(paramContext, paramWindow, paramAppCompatCallback) : new AppCompatDelegateImplV14(paramContext, paramWindow, paramAppCompatCallback));
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/app/AppCompatDelegate.class
