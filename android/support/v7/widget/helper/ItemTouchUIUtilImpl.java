    ...
    public void onDraw(Canvas param1Canvas, RecyclerView param1RecyclerView, View param1View, float param1Float1, float param1Float2, int param1Int, boolean param1Boolean) {
      if (param1Boolean) {
        ...
        if (param1View.getTag(i) == null) {
          ...
          param1View.setTag(i, Float.valueOf(f));
        } 
      } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/helper/ItemTouchUIUtilImpl.class
