...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
  ...
  public boolean onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, V paramV, MotionEvent paramMotionEvent) {
    ...
    if (i != 0) {
      ...
      if (canDragView(paramV) && velocityTracker.isPointInChildBounds((View)paramV, j, i)) {
        this.mLastMotionY = i;
  ...
  private class FlingRunnable implements Runnable {
    ...
    public void run() {
      if (this.mLayout != null) {
        OverScroller overScroller = HeaderBehavior.this.mScroller;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/HeaderBehavior.class
