...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent) {
    ...
    if (paramInt1 == 1) {
      ...
      if (bool) {
        zzbp = zzbp.zzca((Context)this);
        if (paramInt2 != -1) {
          if (paramInt2 == 0)
            zzbp.zza(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1)); 
        } else {
          zzbp.zzafw();
        } 
      } 
      ...
      this.zzfgz = 0;
      setResult(paramInt2, (Intent)zzbp);
    } 
    finish();
  }
  ...
  protected void onCreate(Bundle paramBundle) {
    ...
    if (paramBundle != null)
      this.zzfgz = paramBundle.getInt("resolution"); 
    if (this.zzfgz != 1) {
  ...
  protected void onSaveInstanceState(Bundle paramBundle) {
    paramBundle.putInt("resolution", this.zzfgz);
    super.onSaveInstanceState(paramBundle);
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/com/google/android/gms/common/api/GoogleApiActivity.class
