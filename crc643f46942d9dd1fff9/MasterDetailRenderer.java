...
public class MasterDetailRenderer extends DrawerLayout implements IGCUserPeer, DrawerLayout.DrawerListener {
  ...
  public MasterDetailRenderer(Context paramContext) {
    super(paramContext);
    if (getClass() == MasterDetailRenderer.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.MasterDetailRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android", this, new Object[] { paramContext }); 
  }
  
  public MasterDetailRenderer(Context paramContext, AttributeSet paramAttributeSet) {
    super(paramContext, paramAttributeSet);
    if (getClass() == MasterDetailRenderer.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.MasterDetailRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[] { paramContext, paramAttributeSet }); 
  }
  
  public MasterDetailRenderer(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    super(paramContext, paramAttributeSet, paramInt);
    if (getClass() == MasterDetailRenderer.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.MasterDetailRenderer, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new Object[] { paramContext, paramAttributeSet, Integer.valueOf(paramInt) }); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/crc643f46942d9dd1fff9/MasterDetailRenderer.class
