...
public class NavigationMenuPresenter implements MenuPresenter {
  ...
  final View.OnClickListener mOnClickListener = new View.OnClickListener() {
      public void onClick(View param1View) {
        ...
        boolean bool = navigationMenuPresenter.mMenu.performItemAction((MenuItem)menuItemImpl, navigationMenuPresenter, 0);
  ...
  private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
      ...
      for (k = 0; b < j; k = n) {
        ...
        if (menuItemImpl.hasSubMenu()) {
          ...
          if (m != i) {
            ...
            if (b != 0) {
              i1 = k + 1;
              ArrayList<NavigationMenuPresenter.NavigationMenuItem> arrayList = this.mItems;
              k = NavigationMenuPresenter.this.mPaddingSeparator;
              arrayList.add(new NavigationMenuPresenter.NavigationMenuSeparatorItem(k, k));
              bool1 = bool;
            } 
          } else {
            bool1 = bool;
    ...
    public NavigationMenuPresenter.ViewHolder onCreateViewHolder(ViewGroup param1ViewGroup, int param1Int) {
      if (param1Int != 0)
        return (NavigationMenuPresenter.ViewHolder)((param1Int != 1) ? ((param1Int != 2) ? ((param1Int != 3) ? null : new NavigationMenuPresenter.HeaderViewHolder((View)NavigationMenuPresenter.this.mHeaderLayout)) : new NavigationMenuPresenter.SeparatorViewHolder(NavigationMenuPresenter.this.mLayoutInflater, param1ViewGroup)) : new NavigationMenuPresenter.SubheaderViewHolder(NavigationMenuPresenter.this.mLayoutInflater, param1ViewGroup)); 
      NavigationMenuPresenter navigationMenuPresenter = NavigationMenuPresenter.this;
      return new NavigationMenuPresenter.NormalViewHolder(navigationMenuPresenter.mLayoutInflater, param1ViewGroup, navigationMenuPresenter.mOnClickListener);
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/internal/NavigationMenuPresenter.class
