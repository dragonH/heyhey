...
public class ViewDragHelper {
  ...
  public void processTouchEvent(MotionEvent paramMotionEvent) {
    ...
    if (i != 0) {
        ...
        if (i != 2) {
          ...
          for (m = k; m < j; m++) {
            ...
            if (isValidPointerForActionMove(k)) {
              ...
              float f2 = paramMotionEvent.getY(m);
              float f1 = f3 - this.mInitialMotionX[k];
              float f4 = f2 - this.mInitialMotionY[k];
              reportNewEdgeDrags(f1, f4, k);
              if (this.mDragState == 1)
                break; 
              View view = findTopChildUnder((int)f3, (int)f2);
              if (checkTouchSlop(view, f1, f4) && tryCaptureViewForDrag(view, k))
                break; 
            } 
          } 
          saveLastMotion(paramMotionEvent);
      ...
      j = this.mInitialEdgesTouched[m];
      k = this.mTrackingEdges;
      if ((j & k) != 0)
        this.mCallback.onEdgeTouched(j & k, m); 
    } 
  }
  ...
  public boolean shouldInterceptTouchEvent(MotionEvent paramMotionEvent) {
    ...
    //   521: fload #4
    //   523: iload_2
    //   524: invokespecial saveInitialMotion : (FFI)V
    //   527: aload_0
    //   528: fload #5
    //   530: f2i
    //   531: fload #4
    //   533: f2i
    //   534: invokevirtual findTopChildUnder : (II)Landroid/view/View;
    //   537: astore_1
    //   538: aload_1
    //   539: aload_0
    //   540: getfield mCapturedView : Landroid/view/View;
    //   543: if_acmpne -> 561
    //   546: aload_0
    //   547: getfield mDragState : I
    //   550: iconst_2
    //   551: if_icmpne -> 561
    //   554: aload_0
    //   555: aload_1
    //   556: iload_2
    //   557: invokevirtual tryCaptureViewForDrag : (Landroid/view/View;I)Z
    //   560: pop
    //   561: aload_0
    //   562: getfield mInitialEdgesTouched : [I
    //   565: iload_2
    //   566: iaload
    //   567: istore #6
    //   569: aload_0
    //   570: getfield mTrackingEdges : I
    //   573: istore_3
    //   574: iload #6
    //   576: iload_3
    //   577: iand
    //   578: ifeq -> 593
    //   581: aload_0
    //   582: getfield mCallback : Landroid/support/v4/widget/ViewDragHelper$Callback;
    //   585: iload #6
    //   587: iload_3
    //   588: iand
    //   589: iload_2
    //   590: invokevirtual onEdgeTouched : (II)V
    //   593: iconst_0
    //   594: istore #17
    //   596: aload_0
    //   597: getfield mDragState : I
    //   600: iconst_1
    //   601: if_icmpne -> 607
    //   604: iconst_1
    //   605: istore #17
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/widget/ViewDragHelper.class
