...
public final class RoundedBitmapDrawableFactory {
  ...
  private static class DefaultRoundedBitmapDrawable extends RoundedBitmapDrawable {
    ...
    public void setMipMap(boolean param1Boolean) {
      Bitmap bitmap = this.mBitmap;
      if (bitmap != null) {
        BitmapCompat.setHasMipMap(bitmap, param1Boolean);
        invalidateSelf();
      } 
    }
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/graphics/drawable/RoundedBitmapDrawableFactory.class
