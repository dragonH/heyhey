...
public abstract class MediaBrowserServiceCompat extends Service {
  ...
  class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
    ...
    public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String param1String, int param1Int, Bundle param1Bundle) {
      ...
      if (param1Bundle != null && param1Bundle.getInt("extra_client_version", 0) != 0) {
        ...
        str = (String)MediaBrowserServiceCompat.this.mSession;
        if (str != null) {
          IBinder iBinder;
          IMediaSession iMediaSession = str.getExtraBinder();
  ...
  class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
    public void onCreate() {
      Object object = MediaBrowserServiceCompatApi23.createService((Context)MediaBrowserServiceCompat.this, this);
      this.mServiceObj = object;
      MediaBrowserServiceCompatApi21.onCreate(object);
    }
  ...
  class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
    ...
    public void onCreate() {
      Object object = MediaBrowserServiceCompatApi24.createService((Context)MediaBrowserServiceCompat.this, this);
      this.mServiceObj = object;
      MediaBrowserServiceCompatApi21.onCreate(object);
    }
      ...
      if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
        MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
              public void run() {
                ...
                MediaBrowserServiceCompat.BrowserRoot browserRoot = MediaBrowserServiceCompat.this.onGetRoot(str, uid, bundle);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/media/MediaBrowserServiceCompat.class
