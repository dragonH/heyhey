...
public class DefaultItemAnimator extends SimpleItemAnimator {
  ...
  private void endChangeAnimationIfNecessary(ChangeInfo paramChangeInfo) {
    RecyclerView.ViewHolder viewHolder = paramChangeInfo.oldHolder;
    if (viewHolder != null)
      endChangeAnimationIfNecessary(paramChangeInfo, viewHolder); 
    viewHolder = paramChangeInfo.newHolder;
    if (viewHolder != null)
      endChangeAnimationIfNecessary(paramChangeInfo, viewHolder); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/DefaultItemAnimator.class
