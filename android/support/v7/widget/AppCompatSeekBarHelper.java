...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (tintTypedArray.hasValue(paramInt)) {
      this.mTickMarkTintMode = DrawableUtils.parseTintMode(tintTypedArray.getInt(paramInt, -1), this.mTickMarkTintMode);
      this.mHasTickMarkTintMode = true;
    } 
    paramInt = R.styleable.AppCompatSeekBar_tickMarkTint;
    if (tintTypedArray.hasValue(paramInt)) {
      this.mTickMarkTintList = tintTypedArray.getColorStateList(paramInt);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/AppCompatSeekBarHelper.class
