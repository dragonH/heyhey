...
final class MediaRouterJellybean {
  ...
  static boolean checkRoutedToBluetooth(Context paramContext) {
    boolean bool = false;
    try {
      AudioManager audioManager = (AudioManager)paramContext.getSystemService("audio");
      int i = ((Integer)audioManager.getClass().getDeclaredMethod("getDevicesForStream", new Class[] { int.class }).invoke(audioManager, new Object[] { Integer.valueOf(3) })).intValue();
      if ((i & 0x380) != 0)
        bool = true; 
  ...
  public static List getCategories(Object paramObject) {
    ...
    int i = paramObject.getCategoryCount();
    ArrayList<MediaRouter.RouteCategory> arrayList = new ArrayList(i);
    for (byte b = 0; b < i; b++)
      arrayList.add(paramObject.getCategoryAt(b)); 
    return arrayList;
  }
  ...
  public static List getRoutes(Object paramObject) {
    MediaRouter mediaRouter = (MediaRouter)paramObject;
    int i = mediaRouter.getRouteCount();
    paramObject = new ArrayList(i);
    for (byte b = 0; b < i; b++)
      paramObject.add(mediaRouter.getRouteAt(b)); 
  ...
  public static final class GetDefaultRouteWorkaround {
    ...
    public Object getDefaultRoute(Object param1Object) {
      ...
      if (method != null)
        try {
          return method.invoke(param1Object, new Object[0]);
  ...
  public static final class RouteGroup {
    public static List getGroupedRoutes(Object param1Object) {
      MediaRouter.RouteGroup routeGroup = (MediaRouter.RouteGroup)param1Object;
      int i = routeGroup.getRouteCount();
      param1Object = new ArrayList(i);
      for (byte b = 0; b < i; b++)
        param1Object.add(routeGroup.getRouteAt(b)); 
      return (List)param1Object;
    }
  }
  ...
  public static final class SelectRouteWorkaround {
    ...
    public void selectRoute(Object param1Object1, int param1Int, Object param1Object2) {
      ...
      if ((param1Object2.getSupportedTypes() & 0x800000) == 0) {
        Method method = this.mSelectRouteIntMethod;
        if (method != null) {
          try {
            method.invoke(param1Object1, new Object[] { Integer.valueOf(param1Int), param1Object2 });
            return;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/media/MediaRouterJellybean.class
