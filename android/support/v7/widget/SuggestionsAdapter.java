...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
  ...
  private final SearchManager mSearchManager = (SearchManager)((CursorAdapter)this).mContext.getSystemService("search");
    ...
    if (!TextUtils.isEmpty(str))
      try {
        ...
        if (list != null) {
          ...
          if (i != 0)
            return stringBuilder2.getDrawable(i); 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/SuggestionsAdapter.class
