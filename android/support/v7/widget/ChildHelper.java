  ...
  static class Bucket {
    ...
    void insert(int param1Int, boolean param1Boolean) {
      if (param1Int >= 64) {
        ...
        this.mData = (l1 & (l2 ^ 0xFFFFFFFFFFFFFFFFL)) << 1L | l1 & l2;
        if (param1Boolean) {
          set(param1Int);
        } else {
          clear(param1Int);
    ...
    boolean remove(int param1Int) {
      ...
      this.mData = l2;
      l1--;
      this.mData = l2 & l1 | Long.rotateRight((l1 ^ 0xFFFFFFFFFFFFFFFFL) & l2, 1);
      Bucket bucket = this.mNext;
      if (bucket != null) {
        if (bucket.get(0))
          set(63); 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/ChildHelper.class
