...
public class AppBarLayout extends LinearLayout {
  ...
  public AppBarLayout(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    int j = R.styleable.AppBarLayout_expanded;
    if (typedArray.hasValue(j))
      setExpanded(typedArray.getBoolean(j, false), false, false); 
    if (i >= 21) {
      j = R.styleable.AppBarLayout_elevation;
      if (typedArray.hasValue(j))
        ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator((View)this, typedArray.getDimensionPixelSize(j, 0)); 
    } 
    if (i >= 26) {
      i = R.styleable.AppBarLayout_android_keyboardNavigationCluster;
      if (typedArray.hasValue(i))
        setKeyboardNavigationCluster(typedArray.getBoolean(i, false)); 
      i = R.styleable.AppBarLayout_android_touchscreenBlocksFocus;
      if (typedArray.hasValue(i))
  ...
  protected int[] onCreateDrawableState(int paramInt) {
    ...
    boolean bool = this.mCollapsible;
    paramInt = R.attr.state_collapsible;
    if (!bool)
      paramInt = -paramInt; 
    arrayOfInt1[0] = paramInt;
    if (bool && this.mCollapsed) {
  ...
  public static class Behavior extends HeaderBehavior<AppBarLayout> {
    ...
    private void updateAppBarLayoutDrawableState(CoordinatorLayout param1CoordinatorLayout, AppBarLayout param1AppBarLayout, int param1Int1, int param1Int2, boolean param1Boolean) {
      ...
      //   142: aload_1
      //   143: aload_2
      //   144: invokespecial shouldJumpElevationState : (Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)Z
      //   147: ifeq -> 154
      //   150: aload_2
      //   151: invokevirtual jumpDrawablesToCurrentState : ()V
      //   154: return
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout param1CoordinatorLayout, AppBarLayout param1AppBarLayout, int param1Int) {
      ...
      if (param1Int >= 0 && (i & 0x8) == 0) {
        ...
        setHeaderTopBottomOffset(param1CoordinatorLayout, (V)param1AppBarLayout, i + param1Int);
      } else if (i != 0) {
        if ((i & 0x4) != 0) {
          param1Int = 1;
        } else {
        ...
        if ((i & 0x2) != 0) {
          ...
          if (param1Int != 0) {
            ...
            setHeaderTopBottomOffset(param1CoordinatorLayout, (V)param1AppBarLayout, i);
          } 
        } else if ((i & 0x1) != 0) {
          if (param1Int != 0) {
            animateOffsetTo(param1CoordinatorLayout, param1AppBarLayout, 0, 0.0F);
          } else {
            setHeaderTopBottomOffset(param1CoordinatorLayout, (V)param1AppBarLayout, 0);
          } 
        } 
      } 
    ...
    public void onNestedPreScroll(CoordinatorLayout param1CoordinatorLayout, AppBarLayout param1AppBarLayout, View param1View, int param1Int1, int param1Int2, int[] param1ArrayOfint, int param1Int3) {
      if (param1Int2 != 0) {
        ...
        if (param1Int1 != param1Int3)
          param1ArrayOfint[1] = scroll(param1CoordinatorLayout, (V)param1AppBarLayout, param1Int2, param1Int1, param1Int3); 
      } 
    }
    ...
    public void onNestedScroll(CoordinatorLayout param1CoordinatorLayout, AppBarLayout param1AppBarLayout, View param1View, int param1Int1, int param1Int2, int param1Int3, int param1Int4, int param1Int5) {
      if (param1Int4 < 0)
        scroll(param1CoordinatorLayout, (V)param1AppBarLayout, param1Int4, -param1AppBarLayout.getDownNestedScrollRange(), 0); 
    }
  ...
  public static class LayoutParams extends LinearLayout.LayoutParams {
    ...
    public LayoutParams(Context param1Context, AttributeSet param1AttributeSet) {
      ...
      if (typedArray.hasValue(i))
        this.mScrollInterpolator = AnimationUtils.loadInterpolator(param1Context, typedArray.getResourceId(i, 0)); 
      typedArray.recycle();
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/AppBarLayout.class
