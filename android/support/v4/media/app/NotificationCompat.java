...
public class NotificationCompat {
  ...
  public static class MediaStyle extends android.support.v4.app.NotificationCompat.Style {
    ...
    private RemoteViews generateMediaActionButton(android.support.v4.app.NotificationCompat.Action param1Action) {
      ...
      int i = R.id.action0;
      remoteViews.setImageViewResource(i, param1Action.getIcon());
      if (!bool)
        remoteViews.setOnClickPendingIntent(i, param1Action.getActionIntent()); 
      remoteViews.setContentDescription(i, param1Action.getTitle());
      return remoteViews;
    }
    ...
    RemoteViews generateBigContentView() {
      ...
      if (this.mShowCancelButton) {
        int j = R.id.cancel_action;
        remoteViews.setViewVisibility(j, 0);
        remoteViews.setInt(j, "setAlpha", this.mBuilder.mContext.getResources().getInteger(R.integer.cancel_button_image_alpha));
        remoteViews.setOnClickPendingIntent(j, this.mCancelButtonIntent);
      } else {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/media/app/NotificationCompat.class
