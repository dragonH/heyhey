...
public class ChangeTransform extends Transition {
  ...
  private void createGhostView(ViewGroup paramViewGroup, TransitionValues paramTransitionValues1, TransitionValues paramTransitionValues2) {
    ...
    while (true) {
      ...
      TransitionSet transitionSet2 = changeTransform.mParent;
      if (transitionSet2 != null) {
        transitionSet1 = transitionSet2;
        continue;
      } 
      transitionSet1.addListener(new GhostListener(view, ghostViewImpl));
      if (SUPPORTS_VIEW_REMOVAL_SUPPRESSION) {
        View view1 = paramTransitionValues1.view;
        if (view1 != paramTransitionValues2.view)
          ViewUtils.setTransitionAlpha(view1, 0.0F); 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/ChangeTransform.class
