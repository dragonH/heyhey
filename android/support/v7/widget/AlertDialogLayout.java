...
public class AlertDialogLayout extends LinearLayoutCompat {
  ...
  private boolean tryOnMeasure(int paramInt1, int paramInt2) {
    ...
    for (n = 0; i4 < i; n = i2) {
      ...
      i2 = n;
      if (view.getVisibility() != 8)
        i2 = Math.max(n, view.getMeasuredWidth()); 
      i4++;
    } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/AlertDialogLayout.class
