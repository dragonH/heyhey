  ...
  private static class Api23FingerprintManagerCompatImpl implements FingerprintManagerCompatImpl {
    static FingerprintManagerCompat.CryptoObject unwrapCryptoObject(FingerprintManagerCompatApi23.CryptoObject param1CryptoObject) {
      ...
      if (param1CryptoObject.getMac() != null)
        cryptoObject = new FingerprintManagerCompat.CryptoObject(param1CryptoObject.getMac()); 
      return cryptoObject;
    }
    ...
    private static FingerprintManagerCompatApi23.CryptoObject wrapCryptoObject(FingerprintManagerCompat.CryptoObject param1CryptoObject) {
      FingerprintManagerCompatApi23.CryptoObject cryptoObject = null;
      if (param1CryptoObject == null)
        return null; 
      if (param1CryptoObject.getCipher() != null)
      ...
      if (param1CryptoObject.getMac() != null)
        cryptoObject = new FingerprintManagerCompatApi23.CryptoObject(param1CryptoObject.getMac()); 
      return cryptoObject;
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/hardware/fingerprint/FingerprintManagerCompat.class
