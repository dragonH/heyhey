            ...
            if (fragment3.mContainerId == k)
              if (fragment3 == fragment2) {
                ...
                if (fragment3 == paramFragment) {
                  this.mOps.add(j, new Op(9, fragment3));
                  i = j + 1;
                  fragment = null;
                } 
      ...
      if (k) {
        ...
        if (k != j) {
          for (j = paramInt1; j < paramInt2; j++) {
            ...
            for (m = 0; m < n; m++) {
              int i1;
              fragment = ((Op)backStackRecord.mOps.get(m)).fragment;
              if (fragment != null) {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
