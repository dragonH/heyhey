  ...
  private class MenuState {
    ...
    public void readItem(AttributeSet param1AttributeSet) {
      ...
      if (typedArray.hasValue(i)) {
        this.itemCheckable = typedArray.getBoolean(i, false);
      } else {
      ...
      if (typedArray.hasValue(i)) {
        this.itemIconTintMode = DrawableUtils.parseTintMode(typedArray.getInt(i, -1), this.itemIconTintMode);
      } else {
        this.itemIconTintMode = null;
      } 
      i = R.styleable.MenuItem_iconTint;
      if (typedArray.hasValue(i)) {
        this.itemIconTintList = typedArray.getColorStateList(i);
      } else {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/view/SupportMenuInflater.class
