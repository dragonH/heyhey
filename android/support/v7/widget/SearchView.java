...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
  ...
  public SearchView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    imageView1.setImageDrawable(tintTypedArray.getDrawable(paramInt));
    ...
    imageView5.setImageDrawable(tintTypedArray.getDrawable(paramInt));
  ...
  private static class UpdatableTouchDelegate extends TouchDelegate {
    ...
    public boolean onTouchEvent(MotionEvent param1MotionEvent) {
      ...
      //   216: aload_0
      //   217: getfield mDelegateView : Landroid/view/View;
      //   220: aload_1
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/SearchView.class
