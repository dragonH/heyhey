...
public class WifiP2pManager_GroupInfoListenerImplementor implements IGCUserPeer, WifiP2pManager.GroupInfoListener {
  ...
  static {
    Runtime.register("Android.Net.Wifi.P2p.WifiP2pManager+IGroupInfoListenerImplementor, Mono.Android", WifiP2pManager_GroupInfoListenerImplementor.class, "n_onGroupInfoAvailable:(Landroid/net/wifi/p2p/WifiP2pGroup;)V:GetOnGroupInfoAvailable_Landroid_net_wifi_p2p_WifiP2pGroup_Handler:Android.Net.Wifi.P2p.WifiP2pManager/IGroupInfoListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
  }
  ...
  private native void n_onGroupInfoAvailable(WifiP2pGroup paramWifiP2pGroup);
  ...
  public void onGroupInfoAvailable(WifiP2pGroup paramWifiP2pGroup) {
    n_onGroupInfoAvailable(paramWifiP2pGroup);
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/mono/android/net/wifi/p2p/WifiP2pManager_GroupInfoListenerImplementor.class
