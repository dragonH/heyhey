...
public class ButtonDrawable extends Drawable implements IGCUserPeer {
  ...
  static {
    Runtime.register("Xamarin.Forms.Platform.Android.ButtonDrawable, Xamarin.Forms.Platform.Android", ButtonDrawable.class, "n_isStateful:()Z:GetIsStatefulHandler\nn_getOpacity:()I:GetGetOpacityHandler\nn_draw:(Landroid/graphics/Canvas;)V:GetDraw_Landroid_graphics_Canvas_Handler\nn_setAlpha:(I)V:GetSetAlpha_IHandler\nn_setColorFilter:(Landroid/graphics/ColorFilter;)V:GetSetColorFilter_Landroid_graphics_ColorFilter_Handler\nn_onStateChange:([I)Z:GetOnStateChange_arrayIHandler\n");
  }
  
  public ButtonDrawable() {
    if (getClass() == ButtonDrawable.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.ButtonDrawable, Xamarin.Forms.Platform.Android", "", this, new Object[0]); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/crc643f46942d9dd1fff9/ButtonDrawable.class
