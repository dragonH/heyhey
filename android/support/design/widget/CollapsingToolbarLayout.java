...
public class CollapsingToolbarLayout extends FrameLayout {
  ...
  public CollapsingToolbarLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (typedArray.hasValue(paramInt))
      this.mExpandedMarginStart = typedArray.getDimensionPixelSize(paramInt, 0); 
    paramInt = R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd;
    if (typedArray.hasValue(paramInt))
      this.mExpandedMarginEnd = typedArray.getDimensionPixelSize(paramInt, 0); 
    paramInt = R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop;
    if (typedArray.hasValue(paramInt))
      this.mExpandedMarginTop = typedArray.getDimensionPixelSize(paramInt, 0); 
    paramInt = R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom;
    if (typedArray.hasValue(paramInt))
      this.mExpandedMarginBottom = typedArray.getDimensionPixelSize(paramInt, 0); 
    ...
    if (typedArray.hasValue(paramInt))
      collapsingTextHelper.setExpandedTextAppearance(typedArray.getResourceId(paramInt, 0)); 
    paramInt = R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance;
    if (typedArray.hasValue(paramInt))
      collapsingTextHelper.setCollapsedTextAppearance(typedArray.getResourceId(paramInt, 0)); 
  ...
  static ViewOffsetHelper getViewOffsetHelper(View paramView) {
    ...
    ViewOffsetHelper viewOffsetHelper1 = (ViewOffsetHelper)paramView.getTag(i);
    ...
    if (viewOffsetHelper1 == null) {
      ...
      paramView.setTag(i, viewOffsetHelper2);
    } 
  ...
  private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
    public void onOffsetChanged(AppBarLayout param1AppBarLayout, int param1Int) {
      ...
      collapsingToolbarLayout2.mCurrentOffset = param1Int;
      WindowInsetsCompat windowInsetsCompat = collapsingToolbarLayout2.mLastInsets;
      if (windowInsetsCompat != null) {
        b = windowInsetsCompat.getSystemWindowInsetTop();
      } else {
        b = 0;
      ...
      CollapsingToolbarLayout collapsingToolbarLayout1 = CollapsingToolbarLayout.this;
      if (collapsingToolbarLayout1.mStatusBarScrim != null && b)
        ViewCompat.postInvalidateOnAnimation((View)collapsingToolbarLayout1); 
      i = CollapsingToolbarLayout.this.getHeight();
      j = ViewCompat.getMinimumHeight((View)CollapsingToolbarLayout.this);
      CollapsingToolbarLayout.this.mCollapsingTextHelper.setExpansionFraction(Math.abs(param1Int) / (i - j - b));
    }
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/CollapsingToolbarLayout.class
