...
public final class NotificationManagerCompat {
  ...
  private static class SideChannelManager implements Handler.Callback, ServiceConnection {
    ...
    private boolean ensureServiceBound(ListenerRecord param1ListenerRecord) {
      ...
      boolean bool = this.mContext.bindService(intent, this, 33);
      param1ListenerRecord.bound = bool;
      if (bool) {
    ...
    private void scheduleListenerRetry(ListenerRecord param1ListenerRecord) {
      if (this.mHandler.hasMessages(3, param1ListenerRecord.componentName))
        return; 
      int i = param1ListenerRecord.retryCount + 1;
      param1ListenerRecord.retryCount = i;
      if (i > 6) {
        StringBuilder stringBuilder = new StringBuilder();
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/app/NotificationManagerCompat.class
