  ...
  static LocaleListHelper getDefault() {
    ...
    synchronized (sLock) {
      if (!null.equals(sLastDefaultLocale)) {
        ...
        if (localeListHelper2 != null && null.equals(localeListHelper2.get(0))) {
          localeListHelper1 = sDefaultLocaleList;
          return localeListHelper1;
        } 
        localeListHelper2 = new LocaleListHelper();
      ...
      if (!paramLocaleListHelper.isEmpty())
        synchronized (sLock) {
          ...
          if (paramInt == 0) {
            ...
            this(sLastDefaultLocale, paramLocaleListHelper);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/os/LocaleListHelper.class
