...
public class ViewCompat {
  ...
  static class ViewCompatApi26Impl extends ViewCompatApi24Impl {
    public void addKeyboardNavigationClusters(@NonNull View param1View, @NonNull Collection<View> param1Collection, int param1Int) {
      param1View.addKeyboardNavigationClusters(param1Collection, param1Int);
    }
    
    public int getNextClusterForwardId(@NonNull View param1View) {
      return param1View.getNextClusterForwardId();
    }
    
    public boolean hasExplicitFocusable(@NonNull View param1View) {
      return param1View.hasExplicitFocusable();
    }
    
    public boolean isFocusedByDefault(@NonNull View param1View) {
      return param1View.isFocusedByDefault();
    }
    
    public boolean isKeyboardNavigationCluster(@NonNull View param1View) {
      return param1View.isKeyboardNavigationCluster();
    }
    
    public View keyboardNavigationClusterSearch(@NonNull View param1View1, View param1View2, int param1Int) {
      return param1View1.keyboardNavigationClusterSearch(param1View2, param1Int);
    }
    
    public boolean restoreDefaultFocus(@NonNull View param1View) {
      return param1View.restoreDefaultFocus();
    }
    
    public void setFocusedByDefault(@NonNull View param1View, boolean param1Boolean) {
      param1View.setFocusedByDefault(param1Boolean);
    }
    
    public void setKeyboardNavigationCluster(@NonNull View param1View, boolean param1Boolean) {
      param1View.setKeyboardNavigationCluster(param1Boolean);
    }
    
    public void setNextClusterForwardId(@NonNull View param1View, int param1Int) {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/view/ViewCompat.class
