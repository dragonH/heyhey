...
public class EntryCellView extends LinearLayout implements IGCUserPeer, TextWatcher, NoCopySpan, View.OnFocusChangeListener, TextView.OnEditorActionListener {
  ...
  public EntryCellView(Context paramContext) {
    super(paramContext);
    if (getClass() == EntryCellView.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.EntryCellView, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android", this, new Object[] { paramContext }); 
  }
  
  public EntryCellView(Context paramContext, AttributeSet paramAttributeSet) {
    super(paramContext, paramAttributeSet);
    if (getClass() == EntryCellView.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.EntryCellView, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[] { paramContext, paramAttributeSet }); 
  }
  
  public EntryCellView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    super(paramContext, paramAttributeSet, paramInt);
    if (getClass() == EntryCellView.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.EntryCellView, Xamarin.Forms.Platform.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new Object[] { paramContext, paramAttributeSet, Integer.valueOf(paramInt) }); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/crc643f46942d9dd1fff9/EntryCellView.class
