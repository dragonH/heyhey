...
public final class AppCompatDrawableManager {
  ...
  private ColorStateList createSwitchThumbColorStateList(Context paramContext) {
    ...
    ColorStateList colorStateList = ThemeUtils.getThemeAttrColorStateList(paramContext, i);
  ...
  public static PorterDuffColorFilter getPorterDuffColorFilter(int paramInt, PorterDuff.Mode paramMode) {
    ...
    PorterDuffColorFilter porterDuffColorFilter1 = colorFilterLruCache.get(paramInt, paramMode);
    ...
    if (porterDuffColorFilter1 == null) {
      ...
      colorFilterLruCache.put(paramInt, paramMode, porterDuffColorFilter2);
    } 
      ...
      if (charSequence != null) {
        ...
        if (charSequence.toString().endsWith(".xml")) {
          ...
          try {
            ...
            Log.e("AppCompatDrawableManager", "Exception while inflating drawable", exception);
          } 
        } 
      } 
      if (drawable2 == null)
  ...
  private Drawable tintDrawable(@NonNull Context paramContext, @DrawableRes int paramInt, boolean paramBoolean, @NonNull Drawable paramDrawable) {
    ...
    if (colorStateList != null) {
      ...
      int i = ThemeUtils.getThemeAttrColor((Context)drawable, paramInt);
      PorterDuff.Mode mode = DEFAULT_MODE;
      setPorterDuffColorFilter(drawable1, i, mode);
      setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor((Context)drawable, paramInt), mode);
      setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor((Context)drawable, R.attr.colorControlActivated), mode);
      mode2 = mode1;
    } else {
      if (paramInt == R.drawable.abc_ratingbar_material || paramInt == R.drawable.abc_ratingbar_indicator_material || paramInt == R.drawable.abc_ratingbar_small_material) {
        LayerDrawable layerDrawable = (LayerDrawable)mode1;
        Drawable drawable1 = layerDrawable.findDrawableByLayerId(16908288);
        paramInt = ThemeUtils.getDisabledThemeAttrColor((Context)drawable, R.attr.colorControlNormal);
        null = DEFAULT_MODE;
        setPorterDuffColorFilter(drawable1, paramInt, null);
        drawable1 = layerDrawable.findDrawableByLayerId(16908303);
        paramInt = R.attr.colorControlActivated;
        setPorterDuffColorFilter(drawable1, ThemeUtils.getThemeAttrColor((Context)drawable, paramInt), null);
        setPorterDuffColorFilter(layerDrawable.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor((Context)drawable, paramInt), null);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/AppCompatDrawableManager.class
