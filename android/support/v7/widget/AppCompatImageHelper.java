  ...
  public void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    try {
      ...
      if (tintTypedArray.hasValue(paramInt))
        ImageViewCompat.setImageTintList(this.mView, tintTypedArray.getColorStateList(paramInt)); 
      paramInt = R.styleable.AppCompatImageView_tintMode;
      if (tintTypedArray.hasValue(paramInt))
        ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArray.getInt(paramInt, -1), null)); 
      return;
    } finally {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/AppCompatImageHelper.class
