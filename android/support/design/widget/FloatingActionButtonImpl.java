...
class FloatingActionButtonImpl {
  ...
  FloatingActionButtonImpl(VisibilityAwareImageButton paramVisibilityAwareImageButton, ShadowViewDelegate paramShadowViewDelegate) {
    ...
    this.mRotation = paramVisibilityAwareImageButton.getRotation();
  }
      ...
      this.mView.animate().scaleX(0.0F).scaleY(0.0F).alpha(0.0F).setDuration(200L).setInterpolator((TimeInterpolator)AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener((Animator.AnimatorListener)new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator param1Animator) {
              ...
              if (!this.mCancelled) {
                ...
                visibilityAwareImageButton.internalSetVisibility(b, bool);
  ...
  void setBackgroundDrawable(ColorStateList paramColorStateList, PorterDuff.Mode paramMode, int paramInt1, int paramInt2) {
    ...
    this.mShapeDrawable = drawable3;
    DrawableCompat.setTintList(drawable3, paramColorStateList);
    if (paramMode != null)
    ...
    DrawableCompat.setTintList(drawable2, createColorStateList(paramInt1));
    if (paramInt2 > 0) {
      drawable2 = createBorderDrawable(paramInt2, paramColorStateList);
      this.mBorderDrawable = (CircularBorderDrawable)drawable2;
    ...
    Context context = this.mView.getContext();
    Drawable drawable1 = this.mContentBackground;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/FloatingActionButtonImpl.class
