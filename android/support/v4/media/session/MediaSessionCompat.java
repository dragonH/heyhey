...
public class MediaSessionCompat {
  ...
  public MediaSessionCompat(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent) {
    if (paramContext != null) {
      if (!TextUtils.isEmpty(paramString)) {
        ...
        if (i >= 21) {
          mediaSessionImplApi21 = new MediaSessionImplApi21(paramContext, paramString);
          ...
          this.mImpl = new MediaSessionImplApi19(paramContext, (String)mediaSessionImplApi21, componentName, pendingIntent);
        } else if (i >= 18) {
          this.mImpl = new MediaSessionImplApi18(paramContext, (String)mediaSessionImplApi21, componentName, pendingIntent);
        } else {
          this.mImpl = new MediaSessionImplBase(paramContext, (String)mediaSessionImplApi21, componentName, pendingIntent);
        } 
        this.mController = new MediaControllerCompat(paramContext, this);
        if (sMaxBitmapSize == 0)
  ...
  static class MediaSessionImplApi21 implements MediaSessionImpl {
    ...
    public MediaSessionImplApi21(Context param1Context, String param1String) {
      Object object = MediaSessionCompatApi21.createSession(param1Context, param1String);
      this.mSessionObj = object;
      this.mToken = new MediaSessionCompat.Token(MediaSessionCompatApi21.getSessionToken(object), new ExtraSession());
    }
    
    public MediaSessionImplApi21(Object param1Object) {
      param1Object = MediaSessionCompatApi21.verifySession(param1Object);
      this.mSessionObj = param1Object;
      this.mToken = new MediaSessionCompat.Token(MediaSessionCompatApi21.getSessionToken(param1Object), new ExtraSession());
    }
      ...
      if (this.mShuffleModeEnabled != param1Boolean) {
        ...
        while (true) {
          if (i >= 0) {
            IMediaControllerCallback iMediaControllerCallback = (IMediaControllerCallback)this.mExtraControllerCallbacks.getBroadcastItem(i);
            try {
              iMediaControllerCallback.onShuffleModeChangedDeprecated(param1Boolean);
            } catch (RemoteException remoteException) {}
            i--;
            continue;
          } 
    ...
    class ExtraSession extends IMediaSession.Stub {
      ...
      public void setShuffleModeEnabledDeprecated(boolean param2Boolean) throws RemoteException {
        throw new AssertionError();
      }
  ...
  class ExtraSession extends IMediaSession.Stub {
    ...
    public void setShuffleModeEnabledDeprecated(boolean param1Boolean) throws RemoteException {
      throw new AssertionError();
    }
  ...
  static class MediaSessionImplBase implements MediaSessionImpl {
    ...
    private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback() {
        public void onVolumeChanged(VolumeProviderCompat param2VolumeProviderCompat) {
          ...
          ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, param2VolumeProviderCompat.getVolumeControl(), param2VolumeProviderCompat.getMaxVolume(), param2VolumeProviderCompat.getCurrentVolume());
    ...
    public MediaSessionImplBase(Context param1Context, String param1String, ComponentName param1ComponentName, PendingIntent param1PendingIntent) {
      if (param1ComponentName != null) {
        ...
        this.mToken = new MediaSessionCompat.Token(mediaSessionStub);
        this.mRatingType = 0;
        this.mVolumeType = 1;
        this.mLocalStream = 3;
    ...
    void postToHandler(int param1Int1, Object param1Object, int param1Int2) {
      synchronized (this.mLock) {
        ...
        if (messageHandler != null)
          messageHandler.post(param1Int1, param1Object, param1Int2); 
        return;
      } 
    }
    ...
    void postToHandler(int param1Int, Object param1Object, Bundle param1Bundle) {
      synchronized (this.mLock) {
        MessageHandler messageHandler = this.mHandler;
        if (messageHandler != null)
          messageHandler.post(param1Int, param1Object, param1Bundle); 
        return;
      } 
    }
    ...
    boolean update() {
      ...
      boolean bool1 = true;
      if (bool) {
        bool = this.mIsMbrRegistered;
        if (!bool && (this.mFlags & 0x1) != 0) {
          registerMediaButtonEventReceiver(this.mMediaButtonReceiverIntent, this.mMediaButtonReceiverComponentName);
          this.mIsMbrRegistered = true;
        } else if (bool && (this.mFlags & 0x1) == 0) {
          unregisterMediaButtonEventReceiver(this.mMediaButtonReceiverIntent, this.mMediaButtonReceiverComponentName);
          this.mIsMbrRegistered = false;
        } 
        bool = this.mIsRccRegistered;
        if (!bool && (this.mFlags & 0x2) != 0) {
    ...
    class MediaSessionStub extends IMediaSession.Stub {
      ...
      public PlaybackStateCompat getPlaybackState() {
        synchronized (MediaSessionCompat.MediaSessionImplBase.this.mLock) {
          MediaSessionCompat.MediaSessionImplBase mediaSessionImplBase = MediaSessionCompat.MediaSessionImplBase.this;
          PlaybackStateCompat playbackStateCompat = mediaSessionImplBase.mState;
      ...
      public ParcelableVolumeInfo getVolumeAttributes() {
        synchronized (MediaSessionCompat.MediaSessionImplBase.this.mLock) {
          ...
          int j = mediaSessionImplBase.mLocalStream;
          ...
          if (i == 2) {
            ...
            m = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(j);
      ...
      public void registerCallbackListener(IMediaControllerCallback param2IMediaControllerCallback) {
        ...
        mediaSessionImplBase.mControllerCallbacks.register((IInterface)exception);
      }
      ...
      public boolean sendMediaButton(KeyEvent param2KeyEvent) {
        MediaSessionCompat.MediaSessionImplBase mediaSessionImplBase = MediaSessionCompat.MediaSessionImplBase.this;
        int i = mediaSessionImplBase.mFlags;
        boolean bool = true;
        if ((i & 0x1) == 0)
          bool = false; 
        if (bool)
          mediaSessionImplBase.postToHandler(21, param2KeyEvent); 
        return bool;
      }
    ...
    class MessageHandler extends Handler {
      ...
      public void handleMessage(Message param2Message) {
        ...
        switch (param2Message.what) {
          ...
          case 28:
            list = MediaSessionCompat.MediaSessionImplBase.this.mQueue;
            if (list != null) {
  ...
  class null extends VolumeProviderCompat.Callback {
    public void onVolumeChanged(VolumeProviderCompat param1VolumeProviderCompat) {
      ...
      ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, param1VolumeProviderCompat.getVolumeControl(), param1VolumeProviderCompat.getMaxVolume(), param1VolumeProviderCompat.getCurrentVolume());
  ...
  class MediaSessionStub extends IMediaSession.Stub {
    ...
    public ParcelableVolumeInfo getVolumeAttributes() {
      synchronized (this.this$0.mLock) {
        ...
        if (i == 2) {
          ...
          m = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(j);
          n = this.this$0.mAudioManager.getStreamVolume(j);
        } 
        return new ParcelableVolumeInfo(i, j, k, m, n);
      } 
    }
    ...
    public boolean sendMediaButton(KeyEvent param1KeyEvent) {
      ...
      if ((i & 0x1) == 0)
        bool = false; 
      if (bool)
        mediaSessionImplBase.postToHandler(21, param1KeyEvent); 
      return bool;
    }
  ...
  public static final class QueueItem implements Parcelable {
    ...
    public Object getQueueItem() {
      Object object1 = this.mItem;
      Object object2 = object1;
      if (object1 == null)
        if (Build.VERSION.SDK_INT < 21) {
          object2 = object1;
        } else {
          object2 = MediaSessionCompatApi21.QueueItem.createItem(this.mDescription.getMediaDescription(), this.mId);
          this.mItem = object2;
        }  
      return object2;
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/media/session/MediaSessionCompat.class
