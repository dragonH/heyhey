...
class GhostViewApi14 extends View implements GhostViewImpl {
  ...
  private final ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
      public boolean onPreDraw() {
        GhostViewApi14 ghostViewApi141 = GhostViewApi14.this;
        ghostViewApi141.mCurrentMatrix = ghostViewApi141.mView.getMatrix();
        ViewCompat.postInvalidateOnAnimation(GhostViewApi14.this);
        GhostViewApi14 ghostViewApi142 = GhostViewApi14.this;
        ViewGroup viewGroup = ghostViewApi142.mStartParent;
        if (viewGroup != null) {
          View view = ghostViewApi142.mStartView;
          if (view != null) {
  ...
  protected void onAttachedToWindow() {
    ...
    int i = (int)(arrayOfInt2[1] - this.mView.getTranslationY());
    arrayOfInt2[1] = i;
    this.mDeltaX = arrayOfInt2[0] - arrayOfInt1[0];
    this.mDeltaY = i - arrayOfInt1[1];
  ...
  static class Creator implements GhostViewImpl.Creator {
    ...
    public void removeGhost(View param1View) {
      ...
      if (param1View != null) {
        int i = ((GhostViewApi14)param1View).mReferences - 1;
        ((GhostViewApi14)param1View).mReferences = i;
        if (i <= 0) {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/GhostViewApi14.class
