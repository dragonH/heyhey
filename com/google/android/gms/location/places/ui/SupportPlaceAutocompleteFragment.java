...
public class SupportPlaceAutocompleteFragment extends Fragment {
  ...
  private final void zzatj() {
    ...
    try {
      ...
      this(2);
      Intent intent = intentBuilder.setBoundsBias(this.zziet).setFilter(this.zzieu).zzih(this.zzier.getText().toString()).zzdu(1).build((Activity)getActivity());
      this.zzies = true;
    ...
    if (i != -1)
      GoogleApiAvailability.getInstance().showErrorDialogFragment((Activity)getActivity(), i, 30422); 
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    ...
    this.zziep.setOnClickListener(zze);
    this.zzier.setOnClickListener(zze);
    this.zzieq.setOnClickListener(new zzf(this));
    zzati();
    return view;
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/com/google/android/gms/location/places/ui/SupportPlaceAutocompleteFragment.class
