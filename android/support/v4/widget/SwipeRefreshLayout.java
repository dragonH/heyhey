...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private final Animation mAnimateToCorrectPosition = new Animation() {
      public void applyTransformation(float param1Float, Transformation param1Transformation) {
        ...
        int k = swipeRefreshLayout.mCircleView.getTop();
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    view.layout(paramInt4, paramInt3, paramInt1 - getPaddingLeft() - getPaddingRight() + paramInt4, paramInt2 - getPaddingTop() - getPaddingBottom() + paramInt3);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/widget/SwipeRefreshLayout.class
