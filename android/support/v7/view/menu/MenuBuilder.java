...
public class MenuBuilder implements SupportMenu {
  ...
  public int addIntentOptions(int paramInt1, int paramInt2, int paramInt3, ComponentName paramComponentName, Intent[] paramArrayOfIntent, Intent paramIntent, int paramInt4, MenuItem[] paramArrayOfMenuItem) {
    ...
    while (b3 < b2) {
      ...
      if (paramInt4 < 0) {
        ...
        intent1 = paramArrayOfIntent[paramInt4];
      } 
  ...
  MenuItemImpl findItemWithShortcutForKey(int paramInt, KeyEvent paramKeyEvent) {
    ...
    for (byte b = 0; b < j; b++) {
      ...
      if ((c == arrayOfChar[0] && (i & 0x2) == 0) || (c == arrayOfChar[2] && (i & 0x2) != 0) || (bool && c == '\b' && paramInt == 67))
        return menuItemImpl; 
    } 
    return null;
  }
  ...
  void findItemsWithShortcutForKey(List<MenuItemImpl> paramList, int paramInt, KeyEvent paramKeyEvent) {
    ...
    for (byte b = 0; b < j; b++) {
      ...
      if (k != 0 && c != '\000') {
        char[] arrayOfChar = keyData.meta;
        if ((c == arrayOfChar[0] || c == arrayOfChar[2] || (bool && c == '\b' && paramInt == 67)) && menuItemImpl.isEnabled())
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/view/menu/MenuBuilder.class
