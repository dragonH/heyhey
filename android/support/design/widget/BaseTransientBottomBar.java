...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
  ...
  final SnackbarManager.Callback mManagerCallback = new SnackbarManager.Callback() {
      public void dismiss(int param1Int) {
        ...
        handler.sendMessage(handler.obtainMessage(1, param1Int, 0, BaseTransientBottomBar.this));
      }
    ...
    if (paramViewGroup != null) {
      if (paramView != null) {
        if (paramContentViewCallback != null) {
          ...
          SnackbarBaseLayout snackbarBaseLayout = (SnackbarBaseLayout)LayoutInflater.from(context).inflate(R.layout.design_layout_snackbar, paramViewGroup, false);
  ...
  static class SnackbarBaseLayout extends FrameLayout {
    ...
    SnackbarBaseLayout(Context param1Context, AttributeSet param1AttributeSet) {
      ...
      if (typedArray.hasValue(i))
        ViewCompat.setElevation((View)this, typedArray.getDimensionPixelSize(i, 0)); 
      typedArray.recycle();
      setClickable(true);
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/BaseTransientBottomBar.class
