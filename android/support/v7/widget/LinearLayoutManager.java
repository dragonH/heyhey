...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
  ...
  private void updateLayoutState(int paramInt1, int paramInt2, boolean paramBoolean, RecyclerView.State paramState) {
    ...
    if (paramInt1 == 1) {
      ...
      layoutState1.mCurrentPosition = paramInt1 + layoutState.mItemDirection;
      layoutState.mOffset = this.mOrientationHelper.getDecoratedEnd(view);
      ...
      paramInt1 = getPosition(view);
      LayoutState layoutState1 = this.mLayoutState;
      layoutState2.mCurrentPosition = paramInt1 + layoutState1.mItemDirection;
      layoutState1.mOffset = this.mOrientationHelper.getDecoratedStart(view);
    ...
    if (paramBoolean)
      layoutState.mAvailable = paramInt2 - paramInt1; 
    layoutState.mScrollingOffset = paramInt1;
  }
  ...
  int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState, boolean paramBoolean) {
    ...
    int k = paramLayoutState.mAvailable + paramLayoutState.mExtra;
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LayoutState paramLayoutState, LayoutChunkResult paramLayoutChunkResult) {
    ...
    layoutDecoratedWithMargins(view, k, i, j, m);
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState) {
    ...
    if (paramInt == -1) {
      view1 = findPartiallyOrCompletelyInvisibleChildClosestToStart(paramRecycler, paramState);
    } else {
  ...
  public void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState) {
    ...
    if (!anchorInfo2.mValid || this.mPendingScrollPosition != -1 || this.mPendingSavedState != null) {
      anchorInfo2.reset();
      anchorInfo1 = this.mAnchorInfo;
      anchorInfo1.mLayoutFromEnd = this.mShouldReverseLayout ^ this.mStackFromEnd;
      updateAnchorInfoForLayout(paramRecycler, paramState, anchorInfo1);
      this.mAnchorInfo.mValid = true;
    } else if (anchorInfo1 != null && (this.mOrientationHelper.getDecoratedStart((View)anchorInfo1) >= this.mOrientationHelper.getEndAfterPadding() || this.mOrientationHelper.getDecoratedEnd((View)anchorInfo1) <= this.mOrientationHelper.getStartAfterPadding())) {
      this.mAnchorInfo.assignFromViewAndKeepVisibleRect((View)anchorInfo1);
    } 
    ...
    if (paramState.isPreLayout()) {
      ...
      if (i1 != -1) {
        ...
        if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
          ...
          if (view1 != null) {
            if (this.mShouldReverseLayout) {
              k = this.mOrientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(view1);
    ...
    AnchorInfo anchorInfo1 = this.mAnchorInfo;
    if (anchorInfo1.mLayoutFromEnd ? this.mShouldReverseLayout : !this.mShouldReverseLayout)
      i = 1; 
    onAnchorReady(paramRecycler, paramState, anchorInfo1, i);
    detachAndScrapAttachedViews(paramRecycler);
    this.mLayoutState.mInfinite = resolveIsInfinite();
    this.mLayoutState.mIsPreLayout = paramState.isPreLayout();
    anchorInfo1 = this.mAnchorInfo;
    if (anchorInfo1.mLayoutFromEnd) {
      updateLayoutStateToFillStart(anchorInfo1);
      layoutState = this.mLayoutState;
      layoutState.mExtra = k;
      ...
      fill(paramRecycler, layoutState, paramState, false);
      layoutState = this.mLayoutState;
      m = layoutState.mOffset;
      int i1 = layoutState.mAvailable;
      j = i;
      k = m;
      if (i1 > 0) {
      ...
      updateLayoutStateToFillEnd((AnchorInfo)layoutState);
      layoutState = this.mLayoutState;
  ...
  int scrollBy(int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState) {
    ...
    LayoutState layoutState = this.mLayoutState;
    int j = layoutState.mScrollingOffset + fill(paramRecycler, layoutState, paramState, false);
    if (j < 0)
      return 0; 
    if (i > j)
      paramInt = b * j; 
    ...
    public void assignFromViewAndKeepVisibleRect(View param1View) {
      ...
      if (this.mLayoutFromEnd) {
        ...
        if (j > 0) {
          ...
          i = LinearLayoutManager.this.mOrientationHelper.getStartAfterPadding();
          i = m - k - i + Math.min(LinearLayoutManager.this.mOrientationHelper.getDecoratedStart(param1View) - i, 0);
          if (i < 0)
        ...
        if (j > 0) {
          ...
          i = LinearLayoutManager.this.mOrientationHelper.getEndAfterPadding() - Math.min(0, m - i - i1) - k + n;
          if (i < 0)
            this.mCoordinate -= Math.min(j, -i); 
        } 
      } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/LinearLayoutManager.class
