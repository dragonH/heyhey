  ...
  public static class Builder {
    ...
    public AudioAttributesCompat build() {
      if (!AudioAttributesCompat.sForceLegacyBehavior && Build.VERSION.SDK_INT >= 21) {
        ...
        object = this.mLegacyStream;
        if (object != null)
          builder.setLegacyStreamType(object.intValue()); 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/media/AudioAttributesCompat.class
