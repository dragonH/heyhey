  ...
  private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
      ...
      private boolean shouldDismiss(View param1View, float param1Float) {
        ...
        if (param1Float != 0.0F) {
          ...
          int m = SwipeDismissBehavior.this.mSwipeDirection;
          if (m == 2)
            return true; 
          if (m == 0) {
      ...
      public void onViewDragStateChanged(int param1Int) {
        SwipeDismissBehavior.OnDismissListener onDismissListener = SwipeDismissBehavior.this.mListener;
        if (onDismissListener != null)
          onDismissListener.onDragStateChanged(param1Int); 
      }
      ...
      public void onViewReleased(View param1View, float param1Float1, float param1Float2) {
        ...
        if (SwipeDismissBehavior.this.mViewDragHelper.settleCapturedViewAt(j, param1View.getTop())) {
          ...
          SwipeDismissBehavior.OnDismissListener onDismissListener = SwipeDismissBehavior.this.mListener;
          if (onDismissListener != null)
            onDismissListener.onDismiss(param1View); 
        } 
      }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/SwipeDismissBehavior.class
