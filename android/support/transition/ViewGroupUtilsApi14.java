...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
  ...
  public void suppressLayout(@NonNull ViewGroup paramViewGroup, boolean paramBoolean) {
    ...
    //   213: getstatic android/support/transition/R$id.transition_layout_save : I
    //   216: istore #6
    //   218: aload_1
    //   219: iload #6
    //   221: invokevirtual getTag : (I)Ljava/lang/Object;
    //   224: checkcast android/animation/LayoutTransition
    //   227: astore_3
    //   228: aload_3
    //   229: ifnull -> 244
    //   232: aload_1
    //   233: iload #6
    //   235: aconst_null
    //   236: invokevirtual setTag : (ILjava/lang/Object;)V
    //   239: aload_1
    //   240: aload_3
    //   241: invokevirtual setLayoutTransition : (Landroid/animation/LayoutTransition;)V
    //   244: return
    //   245: astore_3
    //   246: iload #5
    //   248: istore_2
    ...
    //   169	175	245	java/lang/IllegalAccessException
    //   179	187	190	java/lang/IllegalAccessException
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/ViewGroupUtilsApi14.class
