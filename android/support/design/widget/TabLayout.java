...
public class TabLayout extends HorizontalScrollView {
  ...
  public TabLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    slidingTabStrip.setSelectedIndicatorHeight(null.getDimensionPixelSize(R.styleable.TabLayout_tabIndicatorHeight, 0));
    slidingTabStrip.setSelectedIndicatorColor(null.getColor(R.styleable.TabLayout_tabIndicatorColor, 0));
    ...
    this.mTabPaddingStart = null.getDimensionPixelSize(R.styleable.TabLayout_tabPaddingStart, paramInt);
    ...
    try {
      ...
      if (null.hasValue(paramInt))
        this.mTabTextColors = null.getColorStateList(paramInt); 
      paramInt = R.styleable.TabLayout_tabSelectedTextColor;
      if (null.hasValue(paramInt)) {
        paramInt = null.getColor(paramInt, 0);
  ...
  private void addTabFromItemView(@NonNull TabItem paramTabItem) {
    Tab tab = newTab();
    CharSequence charSequence = paramTabItem.mText;
    if (charSequence != null)
      tab.setText(charSequence); 
    Drawable drawable = paramTabItem.mIcon;
    if (drawable != null)
      tab.setIcon(drawable); 
    int i = paramTabItem.mCustomLayout;
    if (i != 0)
      tab.setCustomView(i); 
  ...
  private class AdapterChangeListener implements ViewPager.OnAdapterChangeListener {
    ...
    public void onAdapterChanged(@NonNull ViewPager param1ViewPager, @Nullable PagerAdapter param1PagerAdapter1, @Nullable PagerAdapter param1PagerAdapter2) {
      ...
      if (tabLayout.mViewPager == param1ViewPager)
        tabLayout.setPagerAdapter(param1PagerAdapter2, this.mAutoRefresh); 
    }
  ...
  private class SlidingTabStrip extends LinearLayout {
    ...
    protected void onMeasure(int param1Int1, int param1Int2) {
      ...
      if (View.MeasureSpec.getMode(param1Int1) != 1073741824)
        return; 
      TabLayout tabLayout = TabLayout.this;
      int i = tabLayout.mMode;
      boolean bool = true;
      if (i == 1 && tabLayout.mTabGravity == 1) {
        int j = getChildCount();
        boolean bool1 = false;
        byte b = 0;
        int k;
        for (k = 0; b < j; k = i) {
          ...
          if (view.getVisibility() == 0)
            i = Math.max(k, view.getMeasuredWidth()); 
          b++;
        } 
        if (k <= 0)
          return; 
  ...
  class null extends AnimatorListenerAdapter {
    public void onAnimationEnd(Animator param1Animator) {
      TabLayout.SlidingTabStrip slidingTabStrip = this.this$1;
      slidingTabStrip.mSelectedPosition = position;
      slidingTabStrip.mSelectionOffset = 0.0F;
    }
  }
  ...
  public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public void onPageScrolled(int param1Int1, float param1Float, int param1Int2) {
      ...
      if (tabLayout != null) {
        ...
        if (param1Int2 != 2 || this.mPreviousScrollState != 0)
          bool1 = true; 
  ...
  class TabView extends LinearLayout {
    ...
    public TabView(Context param1Context) {
      ...
      if (i != 0)
        ViewCompat.setBackground((View)this, AppCompatResources.getDrawable(param1Context, i)); 
    ...
    private void updateTextAndIcon(@Nullable TextView param1TextView, @Nullable ImageView param1ImageView) {
      ...
      if (tab1 != null) {
        drawable = tab1.getIcon();
      } else {
        drawable = null;
      } 
      tab1 = this.mTab;
      if (tab1 != null) {
        charSequence = tab1.getText();
      } else {
        charSequence = null;
      } 
      tab1 = this.mTab;
      if (tab1 != null) {
        CharSequence charSequence1 = tab1.getContentDescription();
      } else {
        tab1 = null;
      } 
      byte b = 0;
    ...
    public void onMeasure(int param1Int1, int param1Int2) {
      ...
      //   214: istore #4
      //   216: aload_0
      //   217: getfield this$0 : Landroid/support/design/widget/TabLayout;
      //   220: getfield mMode : I
      //   223: iconst_1
      //   224: if_icmpne -> 297
      //   227: iload #5
      //   229: istore #4
      ...
      //   245: if_icmpne -> 297
      //   248: aload_0
      //   249: getfield mTextView : Landroid/widget/TextView;
      //   252: invokevirtual getLayout : ()Landroid/text/Layout;
      //   255: astore #8
      //   257: aload #8
      //   259: ifnull -> 294
      //   262: iload #5
      ...
      //   269: iconst_0
      //   270: fload #9
      //   272: invokespecial approximateLineWidth : (Landroid/text/Layout;IF)F
      //   275: aload_0
      //   276: invokevirtual getMeasuredWidth : ()I
      //   279: aload_0
      //   280: invokevirtual getPaddingLeft : ()I
      //   283: isub
      //   284: aload_0
      //   285: invokevirtual getPaddingRight : ()I
      //   288: isub
      //   289: i2f
      //   290: fcmpl
      //   291: ifle -> 297
      ...
      //   299: ifeq -> 327
      //   302: aload_0
      //   303: getfield mTextView : Landroid/widget/TextView;
      //   306: iconst_0
      //   307: fload #9
      //   309: invokevirtual setTextSize : (IF)V
      //   312: aload_0
      //   313: getfield mTextView : Landroid/widget/TextView;
      //   316: iload_1
      //   317: invokevirtual setMaxLines : (I)V
      //   320: aload_0
      //   321: iload #6
      //   323: iload_2
      //   324: invokespecial onMeasure : (II)V
      //   327: return
    }
    ...
    final void update() {
      ...
      if (view == null) {
        ...
        if (textView != null || this.mCustomIconView != null)
          updateTextAndIcon(textView, this.mCustomIconView); 
      } 
      boolean bool2 = bool1;
      if (tab != null) {
        bool2 = bool1;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/TabLayout.class
