...
final class CollapsingTextHelper {
  ...
  private void calculateBaseOffsets() {
    ...
    if (charSequence != null)
      f3 = this.mTextPaint.measureText(charSequence, 0, charSequence.length()); 
    j = GravityCompat.getAbsoluteGravity(this.mExpandedTextGravity, this.mIsRtl);
    i = j & 0x70;
    if (i != 48) {
      if (i != 80) {
        float f = (this.mTextPaint.descent() - this.mTextPaint.ascent()) / 2.0F;
        f2 = this.mTextPaint.descent();
        this.mExpandedDrawY = this.mExpandedBounds.centerY() + f - f2;
      } else {
  ...
  void setCollapsedTextAppearance(int paramInt) {
    ...
    if (tintTypedArray.hasValue(i))
      this.mCollapsedTextColor = tintTypedArray.getColorStateList(i); 
    i = R.styleable.TextAppearance_android_textSize;
    if (tintTypedArray.hasValue(i))
      this.mCollapsedTextSize = tintTypedArray.getDimensionPixelSize(i, (int)this.mCollapsedTextSize); 
  ...
  void setExpandedTextAppearance(int paramInt) {
    ...
    int i = R.styleable.TextAppearance_android_textColor;
    if (tintTypedArray.hasValue(i))
      this.mExpandedTextColor = tintTypedArray.getColorStateList(i); 
    i = R.styleable.TextAppearance_android_textSize;
    if (tintTypedArray.hasValue(i))
      this.mExpandedTextSize = tintTypedArray.getDimensionPixelSize(i, (int)this.mExpandedTextSize); 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/widget/CollapsingTextHelper.class
