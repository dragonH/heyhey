...
public class MenuItemWrapperICS extends BaseMenuWrapper<SupportMenuItem> implements MenuItem {
  ...
  public View getActionView() {
    View view1 = ((SupportMenuItem)this.mWrappedObject).getActionView();
    View view2 = view1;
  ...
  public MenuItem setActionView(View paramView) {
    ...
    ((SupportMenuItem)this.mWrappedObject).setActionView((View)collapsibleActionViewWrapper);
    return this;
  }
  ...
  private class OnActionExpandListenerWrapper extends BaseWrapper<MenuItem.OnActionExpandListener> implements MenuItem.OnActionExpandListener {
    ...
    public boolean onMenuItemActionCollapse(MenuItem param1MenuItem) {
      return ((MenuItem.OnActionExpandListener)this.mWrappedObject).onMenuItemActionCollapse(MenuItemWrapperICS.this.getMenuItemWrapper(param1MenuItem));
    }
    
    public boolean onMenuItemActionExpand(MenuItem param1MenuItem) {
      return ((MenuItem.OnActionExpandListener)this.mWrappedObject).onMenuItemActionExpand(MenuItemWrapperICS.this.getMenuItemWrapper(param1MenuItem));
    }
  }
  ...
  private class OnMenuItemClickListenerWrapper extends BaseWrapper<MenuItem.OnMenuItemClickListener> implements MenuItem.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem param1MenuItem) {
      return ((MenuItem.OnMenuItemClickListener)this.mWrappedObject).onMenuItemClick(MenuItemWrapperICS.this.getMenuItemWrapper(param1MenuItem));
    }
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/view/menu/MenuItemWrapperICS.class
