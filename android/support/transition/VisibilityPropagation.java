...
public abstract class VisibilityPropagation extends TransitionPropagation {
  ...
  public void captureValues(TransitionValues paramTransitionValues) {
    ...
    int i = arrayOfInt[0] + Math.round(view.getTranslationX());
    arrayOfInt[0] = i;
    arrayOfInt[0] = i + view.getWidth() / 2;
    i = arrayOfInt[1] + Math.round(view.getTranslationY());
    arrayOfInt[1] = i;
    arrayOfInt[1] = i + view.getHeight() / 2;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/VisibilityPropagation.class
