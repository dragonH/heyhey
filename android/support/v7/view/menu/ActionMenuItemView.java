...
public class ActionMenuItemView extends AppCompatTextView implements MenuView.ItemView, View.OnClickListener, ActionMenuView.ActionMenuChildView {
  ...
  private class ActionMenuItemForwardingListener extends ForwardingListener {
    ...
    public ShowableListMenu getPopup() {
      ActionMenuItemView.PopupCallback popupCallback = ActionMenuItemView.this.mPopupCallback;
    ...
    protected boolean onForwardingStarted() {
      ...
      if (itemInvoker != null) {
        bool2 = bool1;
        if (itemInvoker.invokeItem(actionMenuItemView.mItemData)) {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/view/menu/ActionMenuItemView.class
