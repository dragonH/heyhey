...
public abstract class JobIntentService extends Service {
  ...
  static WorkEnqueuer getWorkEnqueuer(Context paramContext, ComponentName paramComponentName, boolean paramBoolean, int paramInt) {
    ...
    WorkEnqueuer workEnqueuer1 = hashMap.get(paramComponentName);
    ...
    if (workEnqueuer1 == null) {
      ...
      hashMap.put(paramComponentName, compatWorkEnqueuer);
  ...
  void processorFinished() {
    ...
    //   32: aload_0
    //   33: iconst_0
    //   34: invokevirtual ensureProcessorRunningLocked : (Z)V
    //   37: goto -> 54
    //   40: aload_0
    //   41: getfield mDestroyed : Z
    //   44: ifne -> 54
    //   47: aload_0
    //   48: getfield mCompatWorkEnqueuer : Landroid/support/v4/app/JobIntentService$WorkEnqueuer;
    //   51: invokevirtual serviceProcessingFinished : ()V
    //   54: aload_1
    //   55: monitorexit
    //   56: goto -> 64
    //   59: astore_2
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/app/JobIntentService.class
