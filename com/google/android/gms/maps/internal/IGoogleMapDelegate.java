...
public interface IGoogleMapDelegate extends IInterface {
  zzd addCircle(CircleOptions paramCircleOptions) throws RemoteException;
  
  zzg addGroundOverlay(GroundOverlayOptions paramGroundOverlayOptions) throws RemoteException;
  
  zzp addMarker(MarkerOptions paramMarkerOptions) throws RemoteException;
  
  zzs addPolygon(PolygonOptions paramPolygonOptions) throws RemoteException;
  
  IPolylineDelegate addPolyline(PolylineOptions paramPolylineOptions) throws RemoteException;
  
  zzw addTileOverlay(TileOverlayOptions paramTileOverlayOptions) throws RemoteException;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/com/google/android/gms/maps/internal/IGoogleMapDelegate.class
