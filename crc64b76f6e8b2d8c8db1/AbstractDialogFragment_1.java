...
public abstract class AbstractDialogFragment_1 extends DialogFragment implements IGCUserPeer {
  ...
  static {
    Runtime.register("Acr.UserDialogs.Fragments.AbstractDialogFragment`1, Acr.UserDialogs", AbstractDialogFragment_1.class, "n_onSaveInstanceState:(Landroid/os/Bundle;)V:GetOnSaveInstanceState_Landroid_os_Bundle_Handler\nn_onCreateDialog:(Landroid/os/Bundle;)Landroid/app/Dialog;:GetOnCreateDialog_Landroid_os_Bundle_Handler\nn_onDetach:()V:GetOnDetachHandler\n");
  }
  
  public AbstractDialogFragment_1() {
    if (getClass() == AbstractDialogFragment_1.class)
      TypeManager.Activate("Acr.UserDialogs.Fragments.AbstractDialogFragment`1, Acr.UserDialogs", "", this, new Object[0]); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/crc64b76f6e8b2d8c8db1/AbstractDialogFragment_1.class
