...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
  ...
  public void computeScroll() {
    if (this.mScroller.computeScrollOffset()) {
      ...
      if (k != 0) {
        ...
        j = getScrollY();
        overScrollByCompat(0, k, getScrollX(), j, 0, m, 0, 0, false);
        int n = getScrollY() - j;
        if (!dispatchNestedScroll(0, n, 0, k - n, null, 1)) {
          k = getOverScrollMode();
          if (k == 0 || (k == 1 && m > 0)) {
            k = 1;
          } else {
  ...
  public boolean fullScroll(int paramInt) {
    ...
    rect = this.mTempRect;
    return scrollAndFocus(paramInt, rect.top, rect.bottom);
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (getChildCount() > 0) {
      ...
      if (view.getMeasuredHeight() < paramInt2) {
        ...
        view.measure(FrameLayout.getChildMeasureSpec(paramInt1, getPaddingLeft() + getPaddingRight(), layoutParams.width), View.MeasureSpec.makeMeasureSpec(paramInt2 - getPaddingTop() - getPaddingBottom(), 1073741824));
      } 
    } 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/widget/NestedScrollView.class
