...
public class ShareActionProvider extends ActionProvider {
  ...
  private class ShareActivityChooserModelPolicy implements ActivityChooserModel.OnChooseActivityListener {
    public boolean onChooseActivity(ActivityChooserModel param1ActivityChooserModel, Intent param1Intent) {
      ...
      if (onShareTargetSelectedListener != null)
        onShareTargetSelectedListener.onShareTargetSelected(shareActionProvider, param1Intent); 
      return false;
    }
  }
  ...
  private class ShareMenuItemOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
    public boolean onMenuItemClick(MenuItem param1MenuItem) {
      ShareActionProvider shareActionProvider = ShareActionProvider.this;
      Intent intent = ActivityChooserModel.get(shareActionProvider.mContext, shareActionProvider.mShareHistoryFileName).chooseActivity(param1MenuItem.getItemId());
      if (intent != null) {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/ShareActionProvider.class
