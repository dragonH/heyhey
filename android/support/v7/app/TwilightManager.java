...
class TwilightManager {
  ...
  private Location getLastKnownLocationForProvider(String paramString) {
    ...
    if (locationManager != null)
      try {
        if (locationManager.isProviderEnabled(paramString))
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/app/TwilightManager.class
