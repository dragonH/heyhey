...
class TransitionUtils {
  ...
  static class MatrixEvaluator implements TypeEvaluator<Matrix> {
    ...
    public Matrix evaluate(float param1Float, Matrix param1Matrix1, Matrix param1Matrix2) {
      ...
      for (byte b = 0; b < 9; b++) {
        float[] arrayOfFloat = this.mTempEndValues;
        float f1 = arrayOfFloat[b];
        float f2 = this.mTempStartValues[b];
        arrayOfFloat[b] = f2 + (f1 - f2) * param1Float;
      } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/TransitionUtils.class
