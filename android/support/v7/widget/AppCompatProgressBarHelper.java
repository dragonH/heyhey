...
class AppCompatProgressBarHelper {
  ...
  private Drawable tileify(Drawable paramDrawable, boolean paramBoolean) {
    ...
    if (paramDrawable instanceof DrawableWrapper) {
      DrawableWrapper drawableWrapper = (DrawableWrapper)paramDrawable;
      Drawable drawable = drawableWrapper.getWrappedDrawable();
      if (drawable != null)
        drawableWrapper.setWrappedDrawable(tileify(drawable, paramBoolean)); 
    } else {
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/AppCompatProgressBarHelper.class
