...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
  ...
  public ActivityChooserView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    LinearLayoutCompat linearLayoutCompat = (LinearLayoutCompat)findViewById(R.id.activity_chooser_view_content);
    ...
    paramInt = R.id.image;
    this.mDefaultActivityButtonImage = (ImageView)frameLayout.findViewById(paramInt);
  ...
  private class ActivityChooserViewAdapter extends BaseAdapter {
    ...
    public View getView(int param1Int, View param1View, ViewGroup param1ViewGroup) {
      ...
      //   188: aload_2
      //   189: aload_3
      //   190: invokevirtual loadLabel : (Landroid/content/pm/PackageManager;)Ljava/lang/CharSequence;
      //   193: invokevirtual setText : (Ljava/lang/CharSequence;)V
      //   196: aload_0
      //   197: getfield mShowDefaultActivity : Z
      //   200: ifeq -> 223
      //   203: iload_1
      //   204: ifne -> 223
      //   207: aload_0
      //   208: getfield mHighlightDefaultActivity : Z
      //   211: ifeq -> 223
      //   214: aload #5
      //   216: iconst_1
      //   217: invokevirtual setActivated : (Z)V
      //   220: goto -> 229
      //   223: aload #5
      //   225: iconst_0
      //   226: invokevirtual setActivated : (Z)V
      //   229: aload #5
      //   231: areturn
    }
  ...
  private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
    ...
    public void onClick(View param1View) {
      ...
      if (param1View == activityChooserView.mDefaultActivityButton) {
        ...
        if (intent == activityChooserView.mExpandActivityOverflowButton) {
    ...
    public void onItemClick(AdapterView<?> param1AdapterView, View param1View, int param1Int, long param1Long) {
      ...
      if (i != 0) {
        ...
        if (activityChooserView.mIsSelectingDefaultActivity) {
          if (param1Int > 0)
            activityChooserView.mAdapter.getDataModel().setDefaultActivity(param1Int); 
        } else {
    ...
    public boolean onLongClick(View param1View) {
      ...
      if (param1View == activityChooserView.mDefaultActivityButton) {
        if (activityChooserView.mAdapter.getCount() > 0) {
          ActivityChooserView activityChooserView1 = ActivityChooserView.this;
          activityChooserView1.mIsSelectingDefaultActivity = true;
          activityChooserView1.showPopupUnchecked(activityChooserView1.mInitialActivityCount);
        } 
        return true;
      } 
      throw new IllegalArgumentException();
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/ActivityChooserView.class
