...
class AlertController {
  ...
  private final View.OnClickListener mButtonHandler = new View.OnClickListener() {
      public void onClick(View param1View) {
        // Byte code:
        //   0: aload_0
        //   1: getfield this$0 : Landroid/support/v7/app/AlertController;
        //   4: astore_2
        //   5: aload_1
        //   6: aload_2
        ...
        //   30: aload_1
        //   31: aload_2
        //   32: getfield mButtonNegative : Landroid/widget/Button;
        //   35: if_acmpne -> 55
        //   38: aload_2
        //   39: getfield mButtonNegativeMessage : Landroid/os/Message;
        //   42: astore_3
        //   43: aload_3
        //   44: ifnull -> 55
        //   47: aload_3
        ...
        //   55: aload_1
        //   56: aload_2
        //   57: getfield mButtonNeutral : Landroid/widget/Button;
        //   60: if_acmpne -> 80
        //   63: aload_2
        //   64: getfield mButtonNeutralMessage : Landroid/os/Message;
        //   67: astore_1
        //   68: aload_1
        //   69: ifnull -> 80
        //   72: aload_1
        ...
        //   90: aload_0
        //   91: getfield this$0 : Landroid/support/v7/app/AlertController;
        //   94: astore_1
        //   95: aload_1
        //   96: getfield mHandler : Landroid/os/Handler;
        //   99: iconst_1
        //   100: aload_1
        //   101: getfield mDialog : Landroid/support/v7/app/AppCompatDialog;
  ...
  private void setupView() {
    ...
    if (j == 0) {
      ...
      if (nestedScrollView != null) {
        ...
        if (bool)
          j = 2; 
        setScrollIndicators(viewGroup3, (View)nestedScrollView, m | j, 3);
      } 
    } 
    listView = this.mListView;
    if (listView != null) {
  ...
  class null extends CursorAdapter {
    ...
    null(Context param1Context, Cursor param1Cursor, boolean param1Boolean) {
      ...
      this.mLabelIndex = cursor.getColumnIndexOrThrow(((AlertController.AlertParams)AlertController.this).mLabelColumn);
      this.mIsCheckedIndex = cursor.getColumnIndexOrThrow(((AlertController.AlertParams)AlertController.this).mIsCheckedColumn);
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/app/AlertController.class
