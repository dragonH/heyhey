...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    return (f1 > 0.0F) ? constrain(f1 * paramFloat3, paramFloat1, paramFloat2) : -constrain(-f1 * paramFloat3, paramFloat1, paramFloat2);
  }
  ...
  private class ScrollAnimationRunnable implements Runnable {
    public void run() {
      ...
      if (!autoScrollHelper1.mAnimating)
        return; 
      if (autoScrollHelper1.mNeedsReset) {
        autoScrollHelper1.mNeedsReset = false;
        autoScrollHelper1.mScroller.start();
      } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
