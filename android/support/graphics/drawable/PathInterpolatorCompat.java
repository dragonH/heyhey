...
public class PathInterpolatorCompat implements Interpolator {
  ...
  private void initPath(Path paramPath) {
    ...
    if (i > 0) {
      ...
      int j;
      for (j = 0; j < i; j++) {
        pathMeasure.getPosTan(j * f / (i - 1), arrayOfFloat2, null);
      ...
      j = i - 1;
      stringBuilder1.append(arrayOfFloat1[j]);
      stringBuilder1.append(",");
  ...
  public float getInterpolation(float paramFloat) {
    ...
    f2 = arrayOfFloat[i];
    return f2 + paramFloat * (arrayOfFloat[j] - f2);
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/graphics/drawable/PathInterpolatorCompat.class
