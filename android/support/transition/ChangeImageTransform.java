...
public class ChangeImageTransform extends Transition {
  ...
  private static Matrix centerCropMatrix(ImageView paramImageView) {
    ...
    i = Math.round((f1 - f2 * f3) / 2.0F);
    int j = Math.round((f4 - f5 * f3) / 2.0F);
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/ChangeImageTransform.class
