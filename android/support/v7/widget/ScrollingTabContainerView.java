  ...
  private class TabView extends LinearLayoutCompat {
    ...
    public void onMeasure(int param1Int1, int param1Int2) {
      ...
      if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
        ...
        param1Int1 = ScrollingTabContainerView.this.mMaxTabWidth;
        if (i > param1Int1)
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/ScrollingTabContainerView.class
