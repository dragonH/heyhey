...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static final class Builder {
    ...
    public Builder() {
      this.mCustomActions = new ArrayList<PlaybackStateCompat.CustomAction>();
    ...
    public Builder(PlaybackStateCompat param1PlaybackStateCompat) {
      ...
      List<PlaybackStateCompat.CustomAction> list = param1PlaybackStateCompat.mCustomActions;
      if (list != null)
  ...
  public static final class CustomAction implements Parcelable {
    ...
    public Object getCustomAction() {
      Object object1 = this.mCustomActionObj;
      Object object2 = object1;
      if (object1 == null)
        if (Build.VERSION.SDK_INT < 21) {
          object2 = object1;
        } else {
          object2 = PlaybackStateCompatApi21.CustomAction.newInstance(this.mAction, this.mName, this.mIcon, this.mExtras);
          this.mCustomActionObj = object2;
        }  
      return object2;
    }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/media/session/PlaybackStateCompat.class
