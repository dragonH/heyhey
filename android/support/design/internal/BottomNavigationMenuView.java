  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (this.mShiftingMode) {
      ...
      while (paramInt1 < i) {
        ...
        if (paramInt1 == this.mSelectedItemPosition) {
          n = k;
        } else {
          n = m;
        } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/design/internal/BottomNavigationMenuView.class
