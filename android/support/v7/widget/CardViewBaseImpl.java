    ...
    RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper() {
        public void drawRoundRect(Canvas param1Canvas, RectF param1RectF, float param1Float, Paint param1Paint) {
          ...
          if (param1Float >= 1.0F) {
            ...
            f1 = param1RectF.left;
            f3 = param1RectF.top;
            param1Canvas.drawRect(f1 + f4 - 1.0F, f3, param1RectF.right - f4 + 1.0F, f3 + f4, param1Paint);
            f3 = param1RectF.left;
            f1 = param1RectF.bottom;
            param1Canvas.drawRect(f3 + f4 - 1.0F, f1 - f4, param1RectF.right - f4 + 1.0F, f1, param1Paint);
          } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v7/widget/CardViewBaseImpl.class
