...
public abstract class Transition implements Cloneable {
  ...
  void captureValues(ViewGroup paramViewGroup, boolean paramBoolean) {
    ...
    //   350: if_icmpge -> 389
    //   353: aload_0
    //   354: getfield mNameOverrides : Landroid/support/v4/util/ArrayMap;
    //   357: iload_3
    //   358: invokevirtual keyAt : (I)Ljava/lang/Object;
    //   361: checkcast java/lang/String
    //   364: astore #5
    //   366: aload_1
    //   367: aload_0
    //   368: getfield mStartValues : Landroid/support/transition/TransitionValuesMaps;
    //   371: getfield mNameValues : Landroid/support/v4/util/ArrayMap;
    //   374: aload #5
    //   376: invokevirtual remove : (Ljava/lang/Object;)Ljava/lang/Object;
    //   379: invokevirtual add : (Ljava/lang/Object;)Z
    //   382: pop
    //   383: iinc #3, 1
    //   386: goto -> 343
    //   389: iload #8
    ...
    //   416: iload #8
    //   418: invokevirtual valueAt : (I)Ljava/lang/Object;
    //   421: checkcast java/lang/String
    //   424: astore #6
    //   426: aload_0
    //   427: getfield mStartValues : Landroid/support/transition/TransitionValuesMaps;
    //   430: getfield mNameValues : Landroid/support/v4/util/ArrayMap;
    //   433: aload #6
    //   435: aload #5
          ...
          if (animator != null) {
            ...
            if (transitionValues4 != null) {
              ...
              if (view1 != null && arrayOfString != null && arrayOfString.length > 0) {
                ...
                TransitionValues transitionValues6 = (TransitionValues)paramTransitionValuesMaps2.mViewValues.get(view1);
                ...
                while (true) {
                  if (b < k) {
                    ...
                    if (animationInfo.mValues != null && animationInfo.mView == view1 && animationInfo.mName.equals(getName()) && animationInfo.mValues.equals(transitionValues5)) {
                      animator = null;
                      TransitionValues transitionValues7 = transitionValues5;
                      break;
                    } 
                    b++;
                    continue;
                  } 
                  TransitionValues transitionValues = transitionValues5;
                  break;
                } 
              } else {
                arrayOfString = null;
            ...
            if (arrayOfString2 != null) {
              ...
              arrayMap.put(arrayOfString2, new AnimationInfo(view, getName(), this, ViewUtils.getWindowId((View)paramViewGroup), (TransitionValues)arrayOfString1));
              this.mAnimators.add(arrayOfString2);
            } 
            continue;
          } 
        } 
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/transition/Transition.class
