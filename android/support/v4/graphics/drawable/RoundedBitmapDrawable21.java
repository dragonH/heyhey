...
class RoundedBitmapDrawable21 extends RoundedBitmapDrawable {
  ...
  public void setMipMap(boolean paramBoolean) {
    Bitmap bitmap = this.mBitmap;
    if (bitmap != null) {
      bitmap.setHasMipMap(paramBoolean);
      invalidateSelf();
    } 
  }
}
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/graphics/drawable/RoundedBitmapDrawable21.class
