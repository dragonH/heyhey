...
public class WifiP2pManager_UpnpServiceResponseListenerImplementor implements IGCUserPeer, WifiP2pManager.UpnpServiceResponseListener {
  ...
  static {
    Runtime.register("Android.Net.Wifi.P2p.WifiP2pManager+IUpnpServiceResponseListenerImplementor, Mono.Android", WifiP2pManager_UpnpServiceResponseListenerImplementor.class, "n_onUpnpServiceAvailable:(Ljava/util/List;Landroid/net/wifi/p2p/WifiP2pDevice;)V:GetOnUpnpServiceAvailable_Ljava_util_List_Landroid_net_wifi_p2p_WifiP2pDevice_Handler:Android.Net.Wifi.P2p.WifiP2pManager/IUpnpServiceResponseListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
  }
  ...
  private native void n_onUpnpServiceAvailable(List paramList, WifiP2pDevice paramWifiP2pDevice);
  ...
  public void onUpnpServiceAvailable(List paramList, WifiP2pDevice paramWifiP2pDevice) {
    n_onUpnpServiceAvailable(paramList, paramWifiP2pDevice);
  }
}


/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/mono/android/net/wifi/p2p/WifiP2pManager_UpnpServiceResponseListenerImplementor.class
