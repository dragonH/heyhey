...
public class PickerRenderer_PickerListener implements IGCUserPeer, View.OnClickListener {
  ...
  static {
    Runtime.register("Xamarin.Forms.Platform.Android.PickerRenderer+PickerListener, Xamarin.Forms.Platform.Android", PickerRenderer_PickerListener.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
  }
  
  public PickerRenderer_PickerListener() {
    if (getClass() == PickerRenderer_PickerListener.class)
      TypeManager.Activate("Xamarin.Forms.Platform.Android.PickerRenderer+PickerListener, Xamarin.Forms.Platform.Android", "", this, new Object[0]); 
  }
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/crc643f46942d9dd1fff9/PickerRenderer_PickerListener.class
