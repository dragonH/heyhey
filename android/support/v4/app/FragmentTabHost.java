...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
  ...
  private FragmentTransaction doTabChanged(@Nullable String paramString, @Nullable FragmentTransaction paramFragmentTransaction) {
    ...
    if (this.mLastTab != tabInfo) {
      ...
      if (tabInfo1 != null) {
        Fragment fragment = tabInfo1.fragment;
        if (fragment != null)
      ...
      if (tabInfo != null) {
        ...
        if (fragment == null) {
          ...
          fragmentTransaction.add(this.mContainerId, fragment, tabInfo.tag);
        } else {
  ...
  public void addTab(@NonNull TabHost.TabSpec paramTabSpec, @NonNull Class<?> paramClass, @Nullable Bundle paramBundle) {
    ...
    if (this.mAttached) {
      Fragment fragment = this.mFragmentManager.findFragmentByTag(str);
      tabInfo.fragment = fragment;
  ...
  protected void onAttachedToWindow() {
    ...
    while (b < i) {
      TabInfo tabInfo = this.mTabs.get(b);
      Fragment fragment = this.mFragmentManager.findFragmentByTag(tabInfo.tag);
      tabInfo.fragment = fragment;
...
/* Location:              /home/dragonh/workspace/work/app/apk-reverse/dex-tools-2.1/target-dex2jar.jar!/android/support/v4/app/FragmentTabHost.class
